...
public class Lc_3829_DesignRideSharingSystem {
    /**
        ...
        int[] matchDriverWithRider() 匹配最早到达的空闲司机和最早等待的乘客，并将这两者从系统中移除。
            返回一个大小为 2 的整数数组，result = [driverId, riderId]，表示匹配成功。如果没有可用的匹配，返回 [-1, -1]。
    ...
    */
    ...
    public int[] matchDriverWithRider() {
        if(!riders.isEmpty() && !waitingRiders.contains(riders.peekFirst())) {
            riders.pollFirst();
        }
